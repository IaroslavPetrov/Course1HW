...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        employeeStorage[0] = new Employee("Ivanov Ivan Ivanovich", 2, 90_000);
        employeeStorage[1] = new Employee("Petrov Petr Petrovich", 2, 75_500);
        employeeStorage[2] = new Employee("Vasiliev Vasiliy Vaseevich", 3, 73_000);
        employeeStorage[3] = new Employee("Zaytcev Sergey Igorevich", 4, 132_000);
        employeeStorage[4] = new Employee("Sidorov Sidor Sidorovich", 5, 48_000);
        employeeStorage[5] = new Employee("Petrova Arina Petrovna", 2, 49_000);
        employeeStorage[6] = new Employee("Petrova Alisa Ivanovna", 2, 39_000);
        employeeStorage[7] = new Employee("Kuzmina Elena Nicolaevna", 3, 97_000);
        employeeStorage[8] = new Employee("Semenova Nadya Valilevna", 4, 43_000);
        employeeStorage[9] = new Employee("Tcareva Olga Nikolaevna", 5, 84_000);
